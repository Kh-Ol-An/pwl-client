        ...
        <div className="privacy-policy">
            ...
            <div className="container">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Wish Hub, accessible from
                ...
                <ul>
                    <li>By email: wish.hub.net@gmail.com</li>
                </ul>

                <div className="agree">
                    <Button to="/auth?agree">Agree</Button>
                </div>
            </div>
        </div>
    );
